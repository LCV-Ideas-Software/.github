/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 21077f6f31139ce55c0f7fe794619c60)
...
interface __BaseEnv_Env {
	...
	SLACK_ALERTS_WORKFLOW_WEBHOOK_URL: SecretsStoreSecret;
	SLACK_ACTIVITY_WORKFLOW_WEBHOOK_URL: SecretsStoreSecret;
	SLACK_RELAY_SIGNING_SECRET: SecretsStoreSecret;
	SLACK_RELAY_SIGNING_SECRET_NEXT: SecretsStoreSecret;
	SLACK_DISPATCH_BOT_TOKEN: SecretsStoreSecret;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_RELAY_SIGNING_ACTIVE_SLOT" | "DISPATCH_MODE">> {}
}
