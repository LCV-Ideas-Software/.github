...
- Dependabot prepares and rebases its pull requests automatically. A protected least-privilege credential may update a stale Dependabot head by native rebase and admit that exact SHA to auto-merge or the merge queue; it never admits human-authored or fork pull requests and never bypasses required checks.
