...
- The sponsor landing page lives in [`site/sponsor/`](./site/sponsor/) and renders Mercado Pago Checkout Pro through MercadoPago.js v2 / Wallet Brick, backed by the dedicated `sponsor-motor` Worker at `https://sponsor-motor.lcv.app.br`.
