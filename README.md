...
- The sponsor landing page lives in [`site/sponsor/`](./site/sponsor/) and starts a single-click Mercado Pago Checkout Pro redirect backed by the dedicated `sponsor-motor` Worker at `https://sponsor-motor.lcv.app.br`.
